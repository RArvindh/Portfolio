...
import profile from "D:\srms\images\profile.png";
                ...
                <div className={'dashboard-profile-div'}>
                    <div className={'dashboard-profile-img-container'}>
                        ...
                        <div className={'social-profile-container'}>
                            <a href="https://www.facebook.com" target="_blank"><img src={facebook} className={'social-profile-icon'} /></a>
                            <a href="https://twitter.com" target="_blank"><img src={twitter} className={'social-profile-icon'} /></a>
                            <a href="https://www.linkedin.com/in" target="_blank"><img src={linkedin} className={'social-profile-icon'} /></a>
                            <a href="https://github.com" target="_blank"><img src={github} className={'social-profile-icon'} /></a>
                            <a href="https://www.youtube.com" target="_blank"><img src={youtube} className={'social-profile-icon'} /></a>
                        </div>
                    </div>
                    <div className={'dashboard-profile-details-container'}>
                        <p className={'dashboard-profile-name-label'}>Hello, I'm <span className={'dashboard-profile-name'}>ARVINDH R</span></p>
